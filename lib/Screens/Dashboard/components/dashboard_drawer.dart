...
class _DashboardDrawerState extends State<DashboardDrawer>
  ...
  final List<DrawerMenuItem> menuItems = [
    ...
    DrawerMenuItem(
      icon: Icons.map_rounded, // Map icon
      title: 'Map',
      id: 'map',
      gradient: const LinearGradient(
        colors: [Color(0xFF4facfe), Color(0xFF00f2fe)], // Blue gradient for map
      ),
    ),
    DrawerMenuItem(
      ...
      case 'map':
        try {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => const MapPlaceholderScreen(),
            ),
          );
        } catch (e) {
          _showComingSoonSnackBar(context, 'map');
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          gradient: isActive
              ...
              : null,
          borderRadius: BorderRadius.circular(16),
          border: isActive ? Border.all(color: kPrimaryColor, width: 1) : null,
          boxShadow: isActive
              ? [
                  BoxShadow(
                    // ignore: deprecated_member_use
